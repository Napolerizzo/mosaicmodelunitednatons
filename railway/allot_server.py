...
def send_transfer_emails(original: dict, transferee: dict):
    """Send two emails: (1) original loses portfolio, (2) transferee gains it."""
    if not RESEND_KEY:
        return
    ...
    ctx       = COMMITTEE_FULL.get(committee, {})
    agenda    = ctx.get("agenda","")
    committee_full = ctx.get("name", committee)

    def qr(reg_id):
        import urllib.parse
        return f"https://api.qrserver.com/v1/create-qr-code/?data={urllib.parse.quote(f'{SITE}/verify/{reg_id}')}&size=160x160&bgcolor=050402&color=9b6e09&margin=12"

    # ── Email to ORIGINAL: portfolio removed ──────────────────────────────────
    orig_html = f"""<!DOCTYPE html><html><head><meta charset="utf-8"/></head>
<body style="margin:0;background:#050402;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
...
<tr><td style="border-bottom:1px solid rgba(155,110,9,0.2);padding-bottom:24px;">
<img src="{SITE}/brand-assets/mosaic-logo-nobg.png" height="26" style="opacity:0.88;display:block;"/>
</td></tr>
<tr><td style="padding-top:40px;padding-bottom:8px;">
<span style="border:1.5px solid rgba(200,80,80,0.5);padding:5px 18px;font-size:8.5px;letter-spacing:.48em;text-transform:uppercase;color:#c85050;">PORTFOLIO TRANSFERRED</span>
</td></tr>
<tr><td style="padding-top:20px;">
<h1 style="margin:0;font-size:34px;font-weight:900;letter-spacing:-.04em;color:#e8e4dc;line-height:1.05;">Your portfolio<br/>has been transferred.</h1>
</td></tr>
<tr><td style="padding:18px 0 36px;border-bottom:1px solid rgba(155,110,9,0.1);">
<p style="margin:0;font-size:15px;color:#b5a88e;line-height:1.7;font-style:italic;">
As per your request, your portfolio — <strong style="font-style:normal;color:#e8e4dc;">{portfolio}</strong> in <strong style="font-style:normal;color:#e8e4dc;">{committee}</strong> — has been transferred to <strong style="font-style:normal;color:#e8e4dc;">{transferee.get("name","")}</strong>.
</p>
</td></tr>
<tr><td style="padding:28px 0 12px;">
<p style="margin:0;font-size:12px;color:rgba(180,164,138,0.7);line-height:1.9;">
Registration ID: <strong style="color:#9b6e09;letter-spacing:.1em;">{original.get("reg_id","")}</strong><br/>
You are no longer registered for this portfolio. If this was made in error, contact the Secretariat immediately at <a href="mailto:sameer.jhamb1719@gmail.com" style="color:#9b6e09;text-decoration:none;">sameer.jhamb1719@gmail.com</a>
</p>
</td></tr>
<tr><td style="padding:20px 0 52px;border-top:1px solid rgba(255,255,255,0.04);">
<p style="margin:0;font-size:9.5px;color:rgba(120,108,88,0.45);line-height:1.9;">
<strong style="color:rgba(155,110,9,0.35);">CONFIDENTIALITY NOTICE:</strong> This message was generated by the Mosaic MUN II automated system. © 2026 Mosaic MUN. All rights reserved.
</p>
</td></tr>
</table></td></tr></table></body></html>"""

    # ── Email to TRANSFEREE: portfolio granted ────────────────────────────────
    t_name   = transferee.get("name","Delegate")
    t_fn     = t_name.split()[0]
    t_reg_id = transferee.get("reg_id","")
    t_pwd    = transferee.get("password","")

    trans_html = f"""<!DOCTYPE html><html><head><meta charset="utf-8"/></head>
<body style="margin:0;background:#050402;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
<table width="100%" style="background:#050402;"><tr><td align="center" style="padding:52px 20px 0;">
<table width="580" style="max-width:580px;width:100%;">
<tr><td style="border-bottom:1px solid rgba(155,110,9,0.2);padding-bottom:28px;"><table width="100%"><tr>
<td><img src="{SITE}/brand-assets/mosaic-logo-nobg.png" height="26" style="opacity:0.88;display:block;"/></td>
<td align="right" style="font-size:7.5px;letter-spacing:.38em;text-transform:uppercase;color:rgba(155,110,9,0.4);vertical-align:middle;">OFFICIAL CORRESPONDENCE</td>
</tr></table></td></tr>
<tr><td style="padding-top:44px;padding-bottom:6px;">
<span style="border:1.5px solid rgba(155,110,9,0.5);padding:5px 18px;font-size:8.5px;letter-spacing:.48em;text-transform:uppercase;color:#9b6e09;">PORTFOLIO GRANTED</span>
</td></tr>
<tr><td style="padding-top:20px;padding-bottom:6px;">
<h1 style="margin:0;font-size:38px;font-weight:900;letter-spacing:-.045em;color:#e8e4dc;line-height:1.04;">{t_fn},<br/>you've been<br/>allotted a seat.</h1>
</td></tr>
<tr><td style="padding:18px 0 38px;border-bottom:1px solid rgba(155,110,9,0.1);">
<p style="margin:0;font-size:15px;color:#b5a88e;line-height:1.7;font-style:italic;">
A portfolio has been transferred to you for Mosaic MUN II on 11–12 July 2026 at Saraswati Global School, Faridabad. Your credential is confirmed below.
</p>
</td></tr>
<tr><td style="padding-top:36px;">
<table width="100%" style="border:1px solid rgba(155,110,9,0.3);background:linear-gradient(135deg,rgba(155,110,9,0.06) 0%,rgba(0,0,0,0) 60%);">
<tr><td style="padding:22px 28px 18px;border-bottom:1px solid rgba(155,110,9,0.14);">
<span style="font-size:7px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.55);">MOSAIC MUN II · DELEGATE CREDENTIAL · TRANSFERRED</span>
</td></tr>
<tr><td style="padding:28px;"><table width="100%"><tr>
<td style="vertical-align:top;padding-right:24px;">
<div style="margin-bottom:20px;"><div style="font-size:6.5px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:5px;">DELEGATE</div><div style="font-size:17px;font-weight:700;color:#e8e4dc;">{t_name}</div></div>
<div style="margin-bottom:20px;"><div style="font-size:6.5px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:5px;">COMMITTEE</div><div style="font-size:13px;font-weight:700;color:#e8e4dc;">{committee} — {committee_full}</div></div>
<div style="margin-bottom:20px;"><div style="font-size:6.5px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:5px;">AGENDA</div><div style="font-size:12px;color:#c4b490;font-style:italic;line-height:1.55;">{agenda}</div></div>
<div style="margin-bottom:20px;"><div style="font-size:6.5px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:5px;">PORTFOLIO</div><div style="font-size:16px;font-weight:700;color:#e8e4dc;">{portfolio}</div></div>
<div><div style="font-size:6.5px;letter-spacing:.46em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:8px;">STATUS</div>
<span style="font-size:8.5px;letter-spacing:.3em;color:rgba(155,110,9,.95);border:1px solid rgba(155,110,9,.38);padding:5px 14px;text-transform:uppercase;">CONFIRMED &amp; ACTIVE</span></div>
</td>
<td style="vertical-align:top;text-align:right;width:118px;">
<div style="border:1px solid rgba(155,110,9,0.25);padding:12px;display:inline-block;">
<img src="{qr(t_reg_id)}" width="94" height="94" style="display:block;"/></div>
<div style="font-size:6.5px;letter-spacing:.22em;color:rgba(155,110,9,0.35);margin-top:7px;text-transform:uppercase;text-align:center;">SCAN TO VERIFY</div>
</td></tr></table></td></tr>
<tr><td style="padding:16px 28px;border-top:1px solid rgba(155,110,9,0.1);">
<span style="font-size:7.5px;letter-spacing:.28em;text-transform:uppercase;color:rgba(122,106,78,0.7);">11–12 JULY 2026 · SARASWATI GLOBAL SCHOOL, FARIDABAD</span>
</td></tr></table></td></tr>
<tr><td style="padding:32px 0 8px;"><table style="border-left:2px solid rgba(155,110,9,0.3);padding-left:18px;"><tr><td>
<div style="font-size:7px;letter-spacing:.42em;text-transform:uppercase;color:rgba(155,110,9,0.45);margin-bottom:8px;">YOUR DASHBOARD ACCESS</div>
<div style="font-family:'Courier New',monospace;font-size:14px;color:#9b6e09;letter-spacing:.14em;margin-bottom:8px;">{t_reg_id}</div>
<p style="margin:0;font-size:12px;color:rgba(180,164,138,0.75);line-height:1.9;">
An account has been created for you at <a href="{SITE}/login" style="color:#9b6e09;text-decoration:none;">{SITE}/login</a><br/>
Email: <strong>{transferee.get("email","")}</strong><br/>
Temporary password: <strong style="color:#9b6e09;font-family:'Courier New',monospace;">{t_pwd}</strong><br/>
Please change your password after first login.
</p>
</td></tr></table></td></tr>
<tr><td style="padding:20px 0 0;border-top:1px solid rgba(255,255,255,0.04);">
<p style="margin:0;font-size:9.5px;color:rgba(120,108,88,0.45);line-height:1.9;">
<strong style="color:rgba(155,110,9,0.35);">CONFIDENTIALITY NOTICE:</strong> This message is intended solely for {t_name}. If received in error, delete immediately. This message was generated by the Mosaic MUN II automated system. © 2026 Mosaic MUN.
</p>
</td></tr>
</table></td></tr></table></body></html>"""
    ...
    try:
        httpx.post("https://api.resend.com/emails",
            headers={"Authorization":f"Bearer {RESEND_KEY}","Content-Type":"application/json"},
            json={"from":"Mosaic MUN II <allotments@sandnco.lol>","to":[original.get("email","")],
                  "subject":f"Portfolio Transferred — {committee} | {portfolio} · Mosaic MUN II","html":orig_html},
            timeout=15)
        httpx.post("https://api.resend.com/emails",
            headers={"Authorization":f"Bearer {RESEND_KEY}","Content-Type":"application/json"},
            json={"from":"Mosaic MUN II <allotments@sandnco.lol>","to":[transferee.get("email","")],
                  "subject":f"Portfolio Granted — {committee} | {portfolio} · Mosaic MUN II","html":trans_html},
            timeout=15)
        print(f"  [TRANSFER EMAIL] sent to {original.get('email')} and {transferee.get('email')}")
    except Exception as e:
